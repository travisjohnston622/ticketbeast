...
Route::post('/login', 'Auth\LoginController@showLoginForm')->name('auth.show-login');
...
Route::group(['middleware' => 'auth', 'prefix' => 'backstage', 'namespace' => 'Backstage'], function () {
    ...
    Route::get('/concerts/new', 'ConcertsController@create')->name('backstage.concerts.create');
